  ...
  <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i> <span> Projects</span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="add-post.php">Add Projects</a></li>
                                    <li><a href="manage-posts.php">Manage Projrcts</a></li>
                                     <li><a href="trash-posts.php">Trash Projects</a></li>
                                </ul>
                            </li>  
